...
with st.sidebar:
    ...
    # gegen grosse verlieren -- Norm A stellt 1,6 % der Chunks, Norm B
    #  dagegen 20,6 %. Die Eingrenzung auf ein Sachgebiet stellt die
    ...
    # am Kundenbestand: die Norm A lag sauber in der Wissensbasis und
