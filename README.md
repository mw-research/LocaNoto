...
data/dokumente/
    ...
    Norm A.pdf    -> Sachgebiet "(Basis)"
```

Das ist mehr als Bequemlichkeit. In einem flachen gemeinsamen Index
konkurrieren kleine Dokumente gegen große: Norm A stellt 1,6 % der Chunks
des Beispielkorpus, Norm B dagegen 20,6 % — bei einem Top-k über alle
