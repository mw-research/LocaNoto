...
```bash
git clone [https://github.com/dein-benutzername/locanoto.git](https://github.com/dein-benutzername/locanoto.git)
cd locanoto
...
### 4. Container starten - Starte den Container im Hintergrund. Die App legt beim ersten Start automatisch die benötigten Ordnerstrukturen unter /data an.
docker compose up -d
